...
export class FooterService {
  ...
  getFooter() {
    return [
      ...
      new ComponentItem(ComponentsRegistryService.getComponent("FooterBottomComponent"), {content: 'Test content footer bottom', tag: 'bottom footer', portalFlag: 'localhost'}),
      new ComponentItem(ComponentsRegistryService.getComponent("FooterTopComponent"), {content: 'Test content footer top', tag: 'top footer', portalFlag: 'localhost'}),
    ];
  }
}
